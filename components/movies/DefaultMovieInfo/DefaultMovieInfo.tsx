...
const DefaultMovieInfo = () => {
  ...
  return (
    <div className='bg-black rounded-[4px] py-4 px-3 xl:bg-transparent items-center flex gap-[5%]'>
      ...
      <div className='flex flex-col gap-1 xl:gap-4'>
        <p className='text-white animate-fade-in xl:text-lightGold text-base sm:text-2xl 1xl:text-base xl:!text-2xl'>
