const WhiteHeartIcon = () => {
  return (
    <svg width='25' height='25' viewBox='0 0 32 30' fill='none'>
      <path
        ...
        fill='white'
      />
      <ellipse cx='10' cy='11' rx='9' ry='10' fill='white' />
      <ellipse cx='23' cy='10.5' rx='8' ry='9.5' fill='white' />
      <ellipse cx='16.5' cy='19.5' rx='9.5' ry='5.5' fill='white' />
      <ellipse cx='16' cy='25' rx='5' ry='3' fill='white' />
    </svg>
  )
}
